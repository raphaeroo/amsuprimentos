<?php 
//Formatar os títulos da páginas
...
// Set UI labels for Custom Post Type
  $labels = array(
    ...
    'singular_name'       => _x( 'produtos', 'Post Type Singular Name', 'twentythirteen' ),
    'menu_name'           => __( 'produtos', 'twentythirteen' ),
    'parent_item_colon'   => __( 'produtos Relacionado', 'twentythirteen' ),
    'all_items'           => __( 'Todos os produtos', 'twentythirteen' ),
    'view_item'           => __( 'Ver produtos', 'twentythirteen' ),
    'add_new_item'        => __( 'Adicionar novo produtos', 'twentythirteen' ),
    'add_new'             => __( 'Adicionar novo', 'twentythirteen' ),
    'edit_item'           => __( 'Editar produtos', 'twentythirteen' ),
    'update_item'         => __( 'Atualizar produtos', 'twentythirteen' ),
    'search_items'        => __( 'Buscar por produtos', 'twentythirteen' ),
...
// Set other options for Custom Post Type
  ...
  $args = array(
    ...
    'description'         => __( 'produtos news and reviews', 'twentythirteen' ),
    'labels'              => $labels,
